...
At first, this was going to be a short post, but it ended up being a bit longer than I expected. That is why I have decided to split it into two parts. This first part, which is the one you are reading now, will cover the fundamentals of Itô Calculus, and the second part will cover an introduction to Itô Stochastic Differential Equations.

{{< pdf src="/papers/Understanding_Ito_Calculus_Part_I.pdf" >}}